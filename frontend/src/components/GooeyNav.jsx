        ...
        <nav className="flex relative" style={{ transform: 'translate3d(0,0,0.01px)' }}>
          ...
          >
            {items.map((item, index) => (
              <li
                key={index}
                className={`rounded-full relative cursor-pointer transition-all duration-300 ease-in-out hover:text-white ${
              ...
              >
                <Magnet padding={20} magnetStrength={5}>
                  <Link
                    ...
                    className="outline-none py-[0.8em] px-[1.5em] inline-block"
                  >
                    {item.label}
                  </Link>
                </Magnet>
